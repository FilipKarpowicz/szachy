...
int main(int argc, char **argv)
{
    ...
    if (atoi(argv[2]) == 1)
    {
        while (ocena(plansza) != 100 && ocena(plansza) != -100)
        {
            ...
            glowa = listaruchow(&plansza, plansza.ruch);
            wypiszliste(glowa);
            ruch = jakiruch(&plansza, atoi(argv[1]), -1000, 1000);
            ...
            //printf("ruch bota %c %c na %c %c \n", ruch->z[0], ruch->z[1], ruch->d[0], ruch->d[1]);
        ...
        {*/
            ...
            ruchgracza->d[0] = k;
            ruchgracza->d[1] = l;
            if (ruchgracza->z[0] == 7 && ruchgracza->z[1] == 3 && ruchgracza->z[0] == 7 && ruchgracza->z[1] == 3 && plansza.plansza[7][3] == 'k')
            {
                ruchgracza->roszada = 'r';
            }
            if (ruchgracza->z[0] == 7 && ruchgracza->z[1] == 3 && ruchgracza->z[0] == 7 && ruchgracza->z[1] == 5 && plansza.plansza[7][3] == 'k')
            {
                ruchgracza->roszada = 'r';
            }
            plansza = wykonajruch(plansza, ruchgracza);
